...
<head>
	...
	<title>NADA MUSIK STUDIO BINJAI | Admin Edit Sewa</title>
							...
							<div class="col-md-12">
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<?php 
										$id=$_GET['id'];
										$sqlsewa = "SELECT booking.*,studio.*,kategori.*,users.* FROM booking,studio,kategori,users WHERE booking.id_studio=studio.id_studio
													AND kategori.id_kategori=studio.id_kategori AND users.email=booking.email AND booking.kode_booking ='$id'";
										$querysewa = mysqli_query($koneksidb,$sqlsewa);
										$result = mysqli_fetch_array($querysewa);
										$biayastudio=$result['durasi']*$result['harga'];
										$total = $result['driver']+$biayastudio;
										?>
							...
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Detail Sewa</div>
										...
										<form>
											<div class="form-group">
												<label class="col-sm-2 control-label">Studio/Alat Musik</label>
												<div class="col-sm-4">
													<input type="text" name="namastudio" class="form-control" value="<?php echo $result['nama'];?>" required readonly>
												</div>
											</div>
											<br/>
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" name="tanggal" class="form-control" value="<?php echo IndonesiaTgl($result['tgl']);?>" required readonly>
												</div>
											</div>
											<br/>
											<div class="form-group">
												<div class="col-sm-4">
													<input type="hidden" name="biayastudio" class="form-control" value="<?php echo format_rupiah($biayastudio);?>" required readonly>
												</div>
											</div>
											<br/>
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" name="waktu" class="form-control" value="<?php echo ($result['waktu']);?>" required readonly>
												</div>
											</div>
											<br/>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" name="durasi" class="form-control" value="<?php echo $result['durasi'];?> Jam" required readonly>
												</div>
											</div>
											</form>
									</div>
