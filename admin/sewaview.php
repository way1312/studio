...
if($_GET) {
	...
	$sqlsewa = "SELECT booking.*,studio.*,kategori.*,users.* FROM booking,studio,kategori,users WHERE booking.id_studio=studio.id_studio
				AND kategori.id_kategori=studio.id_kategori AND users.email=booking.email AND booking.kode_booking='$Kode'";
...
<table width="100%">
	...
	<tr>
		<td width="20%"><b>Studio/Alat Musik</b></td>
		<td width="2%"><b>:</b></td>
		<td width="78%"><?php echo $result['nama_kategori'];?>, <?php echo $result['nama'];?></td>
	</tr>
	<tr>
		<td colspan="3">&nbsp;</td>
	</tr>
	...
	<tr>
		<td width="20%"><b>Waktu</b></td>
		<td width="2%"><b>:</b></td>
		<td width="78%"><?php echo ($result['waktu']);?></td>
	</tr>
	<tr>
		<td colspan="3">&nbsp;</td>
	</tr>
