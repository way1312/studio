...
<head>
	...
	<title>NADA MUSIK STUDIO BINJAI | Admin Kelola Sewa</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Data Sewa</h2>
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php
										...
										$sqlsewa = "SELECT booking.*,studio.*,kategori.*,users.* FROM booking,studio,kategori,users WHERE booking.id_studio=studio.id_studio
													AND kategori.id_kategori=studio.id_kategori AND users.email=booking.email ORDER BY booking.kode_booking DESC";
										...
										<tr align="center">
											...
											<td><?php echo IndonesiaTgl(htmlentities($result['tgl']));?></td>
											<td><?php echo (htmlentities($result['waktu']));?></td>
