...
<head>
	...
	<title>NADA MUSIK STUDIO BINJAI | Admin Tambah Studio dan Alat Musik</title>
	<!-- Font awesome -->
...
function valid(theform){
		...
		alert ('Hanya huruf yang diperbolehkan untuk Nama studio!');
	...
	<?php include('includes/leftbar.php');?>
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h2 class="page-title">Tambah Studio dan Alat Musik</h2>
					<div class="row">
						<div class="col-md-12">
							<div class="panel panel-default">
									<div class="panel-heading">Form Tambah Studio dan Alat Musik</div>
								<div class="panel-body">
									<form method="post" name="theform" action="tambahstudioact.php" class="form-horizontal" onsubmit="return valid(this);" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="number" min="0" name="priceperhour" class="form-control" required>
										</div>
									</div>
									<div class="hr-dashed"></div>
									...
									<div class="form-group">
										<div class="col-sm-4">
											Gambar Studio/Alat Musik<span style="color:red">*</span><input type="file" name="img1" accept="image/*" required>
										</div>
									</div>
									<div class="hr-dashed"></div>									
								</div>
