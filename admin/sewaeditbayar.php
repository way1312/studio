...
<head>
	...
	<title>NADA MUSIK STUDIO BINJAI | Admin Edit Sewa Studio dan Alat Musik</title>
									...
									<div class="panel-heading">Detail Sewa</div>
										...
										<form>
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" name="mulai" class="form-control" value="<?php echo IndonesiaTgl($result['tgl']);?>" required readonly>
												</div>
											</div>
											<br/>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" name="selesai" class="form-control" value="<?php echo ($result['waktu']);?>" required readonly>
												</div>
											</div>
											<br/>
											<div class="form-group">
