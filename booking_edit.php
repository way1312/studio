...
<section class="user_profile inner_pages">
	...
	<div class="user_profile_info">	
        ...
        <form method="post" action="update_sewa.php" name="sewa" onSubmit="return valid();" enctype="multipart/form-data"> 
            ...
            <div class="form-group">
			<label>Tanggal</label>
				<input type="date" class="form-control" name="fromdate" placeholder="(dd/mm/yyyy)" value="<?php echo $result['tgl'];?>"readonly>
            </div>
            <div class="form-group">
			<label>Waktu</label>
				<input type="text" class="form-control" name="todate" value="<?php echo $result['waktu'];?>"readonly>
            </div>
            <div class="form-group">
			<label>Durasi</label>
