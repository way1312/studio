...
$sql = "SELECT id_studio from studio";
$query = mysqli_query($koneksidb,$sql);
$cnt = mysqli_num_rows($query);
?>
<p><span><?php echo htmlentities($cnt);?> Item Tersedia</span></p>
</div>
</div>

<?php 
$sql1 = "SELECT studio.*,kategori.* FROM studio,kategori WHERE kategori.id_kategori=studio.id_kategori";
 ...
 ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            <h5><a class="list-name"><?php echo htmlentities($result['nama_kategori']);?>, <?php echo htmlentities($result['nama']);?></a></h5>
            <p class="list-price"><?php echo htmlentities(format_rupiah($result['harga']));?>/Jam</p>
            <p class="list-desc"><?php echo htmlentities($result['deskripsi']);?></p>
            <form method="get" action="booking.php">
			      <input type="hidden" class="form-control" name="vid" value=<?php echo htmlentities($result['id_studio']);?> required>
